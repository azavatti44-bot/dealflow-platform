      ...
      >
        <div>
          <div className="flex items-center gap-2.5">
            <span className="font-serif text-2xl font-bold tracking-wide" style={{ color: "var(--text-primary)" }}>
              DEALNEXA
            </span>
            <span className="w-2 h-2 rounded-full" style={{ background: "var(--accent)" }} />
          </div>
          <p className="text-[10px] mt-1 font-mono tracking-widest" style={{ color: "#A8A29E" }}>
        ...
        <div className="space-y-8">
          <div>
            <h1 className="font-serif text-5xl font-bold leading-[1.15]" style={{ color: "var(--text-primary)" }}>
              Find the deal<br />
              <span style={{ color: "var(--accent)" }}>before</span> it's<br />
              a deal.
            </h1>
            <p className="text-sm mt-5 leading-relaxed max-w-xs" style={{ color: "var(--text-secondary)" }}>
            ...
            {features.map(({ icon: Icon, text }) => (
              <div key={text} className="flex items-center gap-3">
                <div
                  ...
                  style={{ background: "rgba(27,67,50,0.09)" }}
                >
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-10">
        ...
        <div className="lg:hidden mb-10 text-center">
          <div className="flex items-center gap-2 justify-center">
            <span className="font-serif text-xl font-bold" style={{ color: "var(--text-primary)" }}>DEALNEXA</span>
            <span className="w-1.5 h-1.5 rounded-full" style={{ background: "var(--accent)" }} />
          </div>
          <p className="text-[9px] mt-1 font-mono tracking-widest" style={{ color: "#A8A29E" }}>
        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <div
            ...
            style={{ background: "var(--bg-surface)", border: "1px solid rgba(0,0,0,0.06)" }}
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {mode === "signup" && (
              <div className="space-y-1.5">
                <label className="block text-[10px] uppercase tracking-wider" style={{ color: "var(--text-secondary)" }}>
                  Full Name
                </label>
                <input
                  value={name}
