    ...
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-6 space-y-5">
      ...
      <div className="flex items-start gap-3">
        <div className="p-2 rounded-lg" style={{ background: "rgba(110,231,183,0.1)" }}>
          <Database size={20} style={{ color: "#6EE7B7" }} />
        </div>
        <div>
          <h1 className="font-serif text-2xl font-bold" style={{ color: "#F5F0E6" }}>Private Deal Finder</h1>
          <p className="text-xs mt-0.5" style={{ color: "#94A3B8" }}>Reg D equity raises — lower middle market companies approaching exit</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <div key={label} className="rounded-lg p-3 text-center" style={card}>
              <Icon size={14} className="mx-auto mb-1" style={{ color: "#6EE7B7" }} />
      ...
      {loading && (
        <div className="flex items-center justify-center py-16">
          ...
          <span className="text-xs" style={{ color: "#94A3B8" }}>Scanning Reg D filings...</span>
        </div>
      )}
      ...
      {!loading && hasSearched && results.length === 0 && (
        <div className="rounded-xl py-16 text-center" style={card}>
          <Database size={32} className="mx-auto mb-3 opacity-30" style={{ color: "#6EE7B7" }} />
          <p className="text-sm" style={{ color: "#94A3B8" }}>No Reg D filings found for these filters.</p>
